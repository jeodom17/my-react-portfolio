        ...
        <div className="mt-2 py-1 text-center">
          <section class="max-w-8xl mx-auto px-2 sm:px-3 lg:px-6 py-6">
            <div class="text-center pb-12">
              ...
              <h1 class="font-bold text-6xl md:text-4xl lg:text-5xl font-heading text-gray-900">
                Check out some of my Projects below
              </h1>
            </div>
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-8">
              <div class="w-full bg-gray-400 rounded-lg shadow-lg overflow-hidden flex flex-col justify-center items-center border-double border-8 border-blue-900 py-6">
                <div>
                  <h1 className="text-4xl font-bold text-blue-900">Reloc8</h1>
                  <img
                    class="mt-10 object-center object-cover h-auto w-full mt-6"
                    src={require("..//assets/img/reloc8.gif").default}
                    alt="Reloc8"
                  ></img>
                </div>
                <div class="text-center py-8 sm:py-6">
                  <p class="mt-10 text-xl text-white font-bold mb-2">
                    <button class="bg-blue-900 hover:bg-yellow-300 text-white font-bold py-2 px-8 rounded-full">
              ...
              <div class="w-full bg-gray-400 rounded-lg shadow-lg overflow-hidden flex flex-col justify-center items-center border-double border-8 border-blue-900 py-6">
                <div>
                <h1 className="text-4xl text-blue-900 font-bold">Never Alone</h1>
                  <img
                    class="mt-10 object-center object-cover h-auto w-full mt-6"
              ...
              <div class="w-full bg-gray-400 rounded-lg shadow-lg overflow-hidden flex flex-col justify-center items-center border-double border-8 border-blue-900">
                <div>
                <h1 className="text-4xl text-blue-900 font-bold">Budget Tracker</h1>
                  <img
                    class="mt-10 object-center object-cover h-auto w-full"
              ...
              <div class="w-full bg-gray-400 rounded-lg shadow-lg overflow-hidden flex flex-col justify-center items-center border-double border-8 border-blue-900">
                <div>
                <h1 className="text-4xl text-blue-900 font-bold">Day Planner</h1>
                  <img
                    class="mt-10 object-center object-cover h-auto w-full"
                    src={require("..//assets/img/project_screenshot.jpg").default}
                    alt="Makko"
                  ></img>
                </div>
                <div class="text-center py-8 sm:py-6">
              ...
              <div class="w-full bg-gray-400 rounded-lg shadow-lg overflow-hidden flex flex-col justify-center items-center border-double border-8 border-blue-900">
                <div>
                <h1 className="text-4xl text-blue-900 font-bold">Fitness Tracker</h1>
                  <img
                    class="mt-10 object-center object-cover h-auto w-full"
              ...
              <div class="w-full bg-gray-400 rounded-lg shadow-lg overflow-hidden flex flex-col justify-center items-center border-double border-8 border-blue-900">
                ...
                <div class="mt-10 text-center py-8 sm:py-6">
                  <p class="text-xl text-gray-700 font-bold mb-2">
                    PROJECT IN THE WORKS
                  </p>
                  <p class="mt-10 text-base text-gray-400 font-normal">
                    MERN STACK
                  </p>
                </div>
              </div>
